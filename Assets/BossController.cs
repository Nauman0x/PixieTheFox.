...
public class BossController : MonoBehaviour
{
    ...
    private float cherrySpawnInterval = 4f;
    private float shroomSpawnInterval = 10f; 
    ...
    private void InstantiateCherry()
    {
        if (cherryPrefab != null)
        {
            Vector3 spawnPosition = new Vector3(
                transform.position.x + Random.Range(-10f, 0.77f), 
                Mathf.Min(transform.position.y, -0.5f),       
